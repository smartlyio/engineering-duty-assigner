...
class ActivityServiceSpec : Spek({
    describe("createActivityFromEvents") {
        it("contains basic info") {
            val activity = ActicityService.createActivityFromEvents(LocalDate.parse("2018-04-02"), emptyList())
        ...
        it("has amount of missing duties in status") {
            val events = listOf(
                Event(Instant.parse("2018-04-02T09:00:00.00Z"), Instant.parse("2018-04-02T17:00:00.00Z"), "Oskari", "Investigator: X")
            )
